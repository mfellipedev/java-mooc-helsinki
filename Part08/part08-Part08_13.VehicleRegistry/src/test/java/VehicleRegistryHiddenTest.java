...
public class VehicleRegistryHiddenTest {
    ...
    @Points("08-13.1")
    @Test
    public void equalsForLicensePlate() {
    ...
    @Points("08-13.1")
    @Test
    public void hashCodeForLicensePlate() {
    ...
    public void addMethod() throws Throwable {
        ...
        assertEquals("Trying to add a dublicate to the registry should return false\n"
                ...
                + "vr.add( new LicensePlate(\"FI\", \"AAA-111\"), \"Arto\");\n"
                + "vr.add( new LicensePlate(\"FI\", \"AAA-111\"), \"Arto\");",
                false, klass.method(olio, method)
    ...
    @Test
    @Points("08-13.2")
    public void addGetRemove() throws Throwable {
        Object object = create();
    ...
    public void printLicensePlatesMethod2() throws Throwable {
        ...
        char k = (char) ('A' + random.nextInt(25));
        String r1 = "A" + k + "A-111";
        k = (char) ('A' + random.nextInt(25));
        String r2 = "B" + k + "B-222";
        k = (char) ('A' + random.nextInt(25));
        String r3 = "C" + k + "C-333";

        add(object, "FI", r1, "Arto");
        add(object, "FI", r2, "Pekka");
        add(object, "FI", r3, "Jukka");

        String v = "VehicleRegistry vr = new VehicleRegistry(); \n"
                + "vr.add(new LicencePlate(\"FI\", \"" + r1 + "\"), \"Arto\");\n"
                + "vr.add(new LicencePlate(\"FI\", \"" + r2 + "\"), \"Pekka\");\n"
                + "vr.add(new LicencePlate(\"FI\", \"" + r3 + "\"), \"Jukka\");\n"
                + "vr.printLicensePlates()";
    ...
    @Test
    @Points("08-13.3")
    public void printOwners2() throws Throwable {
        String method = "printOwners";
        MockInOut io = new MockInOut("");
        Object object = create();

        add(object, "FI", "AAA-111", "Jukka");
        add(object, "FI", "BBB-222", "Mikko");
        add(object, "FI", "CCC-333", "Jukka");
        ...
        assertTrue("The print was incorrect with the code: \n" + v + "\nyou printed:\n" + out, !out.contains("AXA-111"));
        assertTrue("The print was incorrect with the code: \n" + v + "\nyou printed:\n" + out, !out.contains("BXB-222"));
        assertTrue("The print was incorrect with the code: \n" + v + "\nyou printed:\n" + out, !out.contains("CXC-333"));
        assertTrue("The print was incorrect with the code: \n" + v + "\nyou printed:\n" + out, out.contains("Jukka"));
        assertTrue("The print was incorrect with the code: \n" + v + "\nyou printed:\n" + out, out.contains("Mikko"));
        String jaa = out.substring(out.indexOf("Arto") + 1);
        assertFalse("The same name should not be repeated, print was incorrect when trying: "
                + "\n" + v + "\nyou printed:\n" + out, jaa.contains("Arto"));
    }
    ...
    private void testEquals(String m1, String r1, String m2, String r2, boolean vast) {
        LicensePlate rr1 = new LicensePlate(m1, r1);
        LicensePlate rr2 = new LicensePlate(m2, r2);

        String v = "LicencePlate r1 = new LicencePlate(\"" + m1 + "\", \"" + r1 + "\");\n"
                + "LicencePlate r2 = new LicencePlate(\"" + m2 + "\", \"" + r2 + "\");\n"
                + "r1.equals(r2)";
